...
export interface TSentryOptions
  extends Pick<SentryCliOptions, "url" | "authToken" | "org" | "project" | "vcsRemote" | "dist" | "silent">,
    Pick<SentryCliUploadSourceMapsOptions, "ignoreFile" | "rewrite" | "sourceMapReference" | "stripPrefix" | "stripCommonPrefix" | "validate" | "urlPrefix" | "urlSuffix" | "ext"> {
  /**
