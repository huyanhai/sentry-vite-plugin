import type { SentryCliCommitsOptions, SourceMapsPathDescriptor, SentryCliOptions, SentryCliUploadSourceMapsOptions, SentryCliNewDeployOptions } from "@sentry/cli";
export interface TSentryOptions extends Pick<SentryCliOptions, "url" | "authToken" | "org" | "project" | "vcsRemote" | "dist" | "silent">, Pick<SentryCliUploadSourceMapsOptions, "ignoreFile" | "rewrite" | "sourceMapReference" | "stripPrefix" | "stripCommonPrefix" | "validate" | "urlPrefix" | "urlSuffix" | "ext"> {
    /**
     * Filepaths to scan recursively for source and source map files
     */
    include: string | SourceMapsPathDescriptor | Array<string | SourceMapsPathDescriptor>;
    /**
     ...
     * use `Compilation`.
     */
    errorHandler?: (err: Error, invokeErr: () => void, compilation: unknown) => void;
    /**
    ...
    /**
     * Upload after clean files by .js.map
     */
